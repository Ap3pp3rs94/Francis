...
* `Execution Journal` - recent receipts and active run state, linked back to the current operator move with server-shaped receipt summaries, receipt presentation cards for repo actions, and explicit current-vs-historical state
