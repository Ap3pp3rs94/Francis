...
def _build_app() -> FastAPI:
    ...
    from services.orchestrator.app.routes.connectors import router as connectors_router
    from services.orchestrator.app.routes.dependencies import router as dependencies_router
