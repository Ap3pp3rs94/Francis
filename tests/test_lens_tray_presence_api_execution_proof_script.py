...
def test_lens_tray_presence_api_execution_proof_starts_and_stops_real_tray_runtime(
    ...
    assert payload["recommended_next_slice"] == "prove_governed_os_binding_api_execution_after_tray_presence"
    assert payload["recommended_proof_script"] == "scripts/lens-os-binding-api-execution-proof.ps1 -Mode Status"
