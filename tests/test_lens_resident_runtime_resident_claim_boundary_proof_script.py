...
def test_lens_resident_runtime_resident_claim_boundary_accepts_cached_parent_proofs() -> None:
    script = (_repo_root() / "scripts" / "lens-resident-runtime-resident-claim-boundary-proof.ps1").read_text(
        encoding="utf-8"
    )
