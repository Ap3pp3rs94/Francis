...
def test_lens_host_preflight_reports_blockers_without_authority() -> None:
    ...
    assert "lens_host_persistent_supervision_prerequisites_pending" in blocker_groups["runtime"]
    ...
    assert "process_supervision_enabled" not in blocker_groups["supervision"]
    assert "process_restart_authority" in blocker_groups["supervision"]
    assert "persistent_supervision_enabled" not in blocker_groups["supervision"]
    assert "process_restart_authority" in blocker_groups["supervision"]
