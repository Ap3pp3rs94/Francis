...
def test_reactor_operator_visibility_summary_aggregates_readbacks_without_authority(
    ...
    assert summary["dispatch_engine_boundary_action_total"] == 3
    assert summary["attention"]["dispatch_engine_boundary_action_total"] == 3
    ...
    assert summary["counts"]["dispatch_engine_boundary_action"] == {"execute": 1, "mutate": 1, "plugin_run": 1}
