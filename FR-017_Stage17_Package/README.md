...
- `scripts/fr017-evidence-chain-status.ps1 -Mode Status`: first blocking FR-017 evidence gate, next required input, and the current measurement/mockup/mannequin/static-fit/movement/release-cable capture summary where applicable.
