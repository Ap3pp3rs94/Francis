...
- Staffing: agent `019f6100-9955-78f0-abda-5abd175b953a`
- Availability: `RESPONDED`
- Liveness: current cycle `CR-20260714-002`
- Current assignment: preflight completed; await exact worker commits
...
- Latest verified evidence: `MSG-20260714-008` and
  `reviews/VERA/CR-20260714-preflight.md`; no worker commit exists
