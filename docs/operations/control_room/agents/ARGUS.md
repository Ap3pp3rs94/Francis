...
- Staffing: unstaffed; prior handle `019f6100-97e3-7e23-a5c7-255ec738fd9b`
  returned `not_found`
...
- Runtime lease: `LEASE-ARGUS-001` released with state preserved; reacquisition
  required before any process; services, watcher, and real Orb denied
...
- Next action: remain parked; preserve branch and reacquire the lease only after
  a revised card authorizes work
