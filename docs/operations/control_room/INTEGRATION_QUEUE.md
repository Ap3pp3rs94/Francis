...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CR-FORGE-007 | `codex/forge-rogue-detection-assessment` | `d19bc919`; remediations `aedc6bce`, `224c9859` | 7 focused tests and complete managed-copy card suite | SENTINEL pass | VERA pass | rebased exact-head focused/card/static checks passed | integrated-main push authorized; real incident/containment operator-only | `PROMOTED` |
