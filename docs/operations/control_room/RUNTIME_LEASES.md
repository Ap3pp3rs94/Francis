...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `LEASE-FORGE-003` | FORGE | CR-FORGE-003 | `task_cards/managed-copy-safe-delta-export-preflight.md` | `codex/forge-safe-delta-export-preflight` / `D:\fg` | `FRANCIS_DATA_DIR=D:\Francis-runtime-leases\forge-safe-delta-export-preflight\data` | `18004` / `18784` / `15174` | pytest/Ruff/mypy only | denied | none; test-only lease | 2026-07-15T02:42:00-05:00 | no service; assigned ports unused | `ACQUIRED` |
