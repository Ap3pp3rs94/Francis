...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `LEASE-FORGE-007` | FORGE | CR-FORGE-007 | `task_cards/managed-copy-rogue-detection-assessment.md` | `codex/forge-rogue-detection-assessment` / `D:\fg` | `FRANCIS_DATA_DIR=D:\Francis-runtime-leases\forge-rogue-detection-assessment\data` | `18008` / `18788` / `15178` | pytest/Ruff/mypy only | denied | none; test-only lease | 2026-07-15 | no service; assigned ports must remain unused | `ACQUIRED` |
