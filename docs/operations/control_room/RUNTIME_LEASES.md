...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `LEASE-FORGE-005` | FORGE | CR-FORGE-005 | `task_cards/managed-copy-safe-delta-export-authorization-decision.md` | `codex/forge-safe-delta-export-authorization-decision` / `D:\fg` | `FRANCIS_DATA_DIR=D:\Francis-runtime-leases\forge-safe-delta-export-authorization-decision\data` | `18006` / `18786` / `15176` | pytest/Ruff/mypy only | denied | none; test-only lease | 2026-07-15T06:15:00-05:00 | no service; assigned ports unused | `ACQUIRED` |
