...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `LEASE-FORGE-006` | FORGE | CR-FORGE-006 | `task_cards/managed-copy-safe-delta-export-artifact-plan.md` | `codex/forge-safe-delta-export-artifact-plan` / `D:\fg` | `FRANCIS_DATA_DIR=D:\Francis-runtime-leases\forge-safe-delta-export-artifact-plan\data` | `18007` / `18787` / `15177` | pytest/Ruff/mypy only | denied | none; test-only lease | 2026-07-15T06:44:00-05:00 | no service; assigned ports unused | `ACQUIRED` |
