...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `LEASE-FORGE-004` | FORGE | CR-FORGE-004 | `task_cards/managed-copy-safe-delta-export-authorization-request.md` | `codex/forge-safe-delta-export-authorization-request` / `D:\fg` | `FRANCIS_DATA_DIR=D:\Francis-runtime-leases\forge-safe-delta-export-authorization-request\data` | `18005` / `18785` / `15175` | pytest/Ruff/mypy only | denied | none; test-only lease | 2026-07-15T04:31:00-05:00 | no service; assigned ports unused | `ACQUIRED` |
