...
def _run() -> tuple[int, dict[str, Any]]:
    ...
    try:
        ...
        payload = {
            ...
            "recommended_next_slice": "consume_global_hotkey_binding_boundary_after_api_tray_presence",
            "recommended_proof_script": str(
                recommended_handoff.get("proof_script")
                or "scripts/lens-summon-global-hotkey-binding-blocker-proof.ps1 -Mode Status"
            ),
