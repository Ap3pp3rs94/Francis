...
$SystemResidentBlockers = @($HostBlockers + $HudBlockers + $RuntimePlanBlockers + $HostSupervisorProofBlockers + $ResidentOverlayRuntimeBlockers + $ResidentOverlayActivationBoundaryBlockers | Sort-Object -Unique)
