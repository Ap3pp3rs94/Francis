...
$Criteria = @(
  ...
  (New-Criterion `
      ...
      -Evidence @('/lens/host', '/lens/preflight', 'scripts/lens-host.ps1', 'scripts/lens-host-foreground-proof.ps1') `
...
$Payload = [ordered]@{
  ...
  next_smallest_truthful_gap = 'resident_host_supervision_or_resident_surface_proof'
  governance = [ordered]@{
