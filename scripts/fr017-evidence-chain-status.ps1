...
$Gates = @(
  ...
  (New-GateDefinition -Id 'measurement_intake' -ScriptName 'fr017-measurement-intake.ps1' -ReadyStatus 'ready_for_non_powered_mockup_patterning' -NextRequiredInput 'FR-017-MEASUREMENT-CAPTURE-RUNBOOK.md + FR-017-MEASUREMENTS-INPUT-TEMPLATE.json' -NextCommand 'copy_template_using_measurement_capture_runbook_then_rerun_measurement_intake' -Arguments $MeasurementArgs.ToArray()),
