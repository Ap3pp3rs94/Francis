...
$MeasurementSetupUpdatePath = Join-Path $RepoRoot 'scripts\fr017-update-measurement-setup-record.ps1'
$MeasurementRecordUpdatePath = Join-Path $RepoRoot 'scripts\fr017-update-measurement-record.ps1'
$MeasurementLandmarkUpdatePath = Join-Path $RepoRoot 'scripts\fr017-update-landmark-record.ps1'
$MeasurementIndependenceSafetyUpdatePath = Join-Path $RepoRoot 'scripts\fr017-update-independence-safety-record.ps1'
...
$Output = [ordered]@{
  ...
  measurement_setup_update_path = $MeasurementSetupUpdatePath
  measurement_record_update_path = $MeasurementRecordUpdatePath
  measurement_landmark_update_path = $MeasurementLandmarkUpdatePath
  measurement_independence_safety_update_path = $MeasurementIndependenceSafetyUpdatePath
