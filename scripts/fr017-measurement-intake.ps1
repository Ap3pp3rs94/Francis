...
$Output = [ordered]@{
  ...
  measurement_capture_runbook_contract = 'Use FR-017-MEASUREMENT-CAPTURE-RUNBOOK.md with a copy of FR-017-MEASUREMENTS-INPUT-TEMPLATE.json to capture real left/right Pilot measurements. The runbook is operator guidance only; it is not measurement evidence, physical validation completion, powered testing clearance, frame-coupled testing clearance, or FR-018 clearance.'
  ...
  next_required_physical_input = 'copy_FR-017-MEASUREMENTS-INPUT-TEMPLATE.json_to_FR-017-MEASUREMENTS-YYYY-MM-DD-PILOT-RECORD.json_and_capture_with_FR-017-MEASUREMENT-CAPTURE-RUNBOOK.md'
