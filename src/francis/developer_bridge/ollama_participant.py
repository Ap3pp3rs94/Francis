...
def _build_model_input(item: dict[str, object]) -> str:
    ...
    return (
        ...
        "Treat those as background body/context, not as raw host access, and do not recite the surface list, "
        "Trust Ladder, capability receipts, or governance boilerplate unless the source asks about them or an "
