...
def _event_to_operation(task_id: str, idx: int, event: dict[str, Any]) -> dict[str, Any]:
    ...
    approval_id = _safe_str(details.get("approval_id")).strip()
    return {
...
def status() -> dict[str, object]:
    try:
        ...
        log_api_exception(exc, route="operations.overview")
        return {"ok": False, "route": "operations", "status": "error", "error": api_error_code()}
...
def list_operations(
    ...
    try:
        ...
        log_api_exception(exc, route="operations.list")
        return {"items": [], "total": 0, "offset": 0, "limit": 0, "error": api_error_code()}
...
def get_many_operations(payload: OperationGetManyIn) -> dict[str, object]:
    try:
        ...
        log_api_exception(exc, route="operations.export")
        return {"items": [], "error": api_error_code()}
...
def create_operation(request: Request, payload: OperationCreateIn) -> dict[str, object]:
    ...
    try:
        ...
        log_api_exception(exc, route="operations.create")
...
def run_workers_once(request: Request, payload: WorkerRunOnceIn) -> dict[str, object]:
    ...
    try:
        ...
        log_api_exception(exc, route="operations.supervised_exec")
        return {"ok": False, "exit_code": 1, "error": api_error_code()}
...
def get_operation(operation_id: str) -> dict[str, object]:
    try:
        ...
        log_api_exception(exc, route="operations.get")
        return {"ok": False, "error": api_error_code()}
...
def patch_operation(operation_id: str, request: Request, payload: OperationPatchIn) -> dict[str, object]:
    try:
        ...
        log_api_exception(exc, route="operations.patch")
        return {"ok": False, "error": api_error_code()}
...
def cancel_operation(operation_id: str, request: Request, payload: OperationCancelIn) -> dict[str, object]:
    try:
        ...
        log_api_exception(exc, route="operations.complete")
        return {"ok": False, "error": api_error_code()}
...
def run_operation(operation_id: str, request: Request, payload: OperationRunIn) -> dict[str, object]:
    ...
    try:
        ...
        log_api_exception(exc, route="operations.run")
        return {"ok": False, "error": api_error_code()}
...
def delete_operation(operation_id: str, request: Request, payload: OperationDeleteIn) -> dict[str, object]:
    try:
        ...
        log_api_exception(exc, route="operations.delete")
        return {"ok": False, "error": api_error_code()}
