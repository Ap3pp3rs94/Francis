...
_RULES: tuple[AuthorityRule, ...] = (
    ...
    AuthorityRule(
        ...
        approval_requirement="fresh exact invocation plan fingerprint plus explicit confirmation",
        receipt_behavior="one immutable metadata-only invocation-result receipt",
        denial_behavior="api_permission_denied before lineage inspection, directory creation, or invocation",
        governance_maturity="permission_gated_confirmed_local_invocation_only",
        notes="Evaluates core-review handoff eligibility without network, connector, import, learning, core, or tenant-state mutation.",
    ),
    AuthorityRule(
