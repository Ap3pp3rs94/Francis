      ...
      items: [
        {
          ...
          loop: {
            ...
            current_task_previous_approval_id: "apr_memory_previous",
            current_task_previous_approval_status: "missing",
            current_task_operation_id: "tsk_memory_context",
            current_task_operation_name: "plan.create",
            current_task_operation_plane: "P9_OBSERVABILITY",
            current_task_trace_id: "trace_memory_context",
    ...
    jsonResponse({
      event: {
        ...
        meta: {
          ...
          current_task_previous_approval_id: "apr_meta_previous",
