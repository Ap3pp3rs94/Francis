...
test("formatCollaborationRelayMessage separates current source-alignment receipt fields", () => {
  ...
  assert.equal(
    display.technicalText.includes(
      "Source alignment: Claude guidance acknowledged; Francis subject; Codex validates repo truth",
    ),
    true,
  );
