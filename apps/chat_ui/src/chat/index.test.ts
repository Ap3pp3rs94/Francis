  ...
  const health = parseCollaborationRuntimeHealth({
    ...
    helpers: [
      ...
      },
      {
        ...
        process_model: "wrapper_child_pair",
        effective_worker_count: 1,
        effective_pids: [231386],
        wrapper_process_count: 1,
        wrapper_pids: [231385],
        processes: [
          { pid: 231385, parent_pid: 200003, role: "launcher_wrapper" },
          { pid: 231386, parent_pid: 231385, role: "effective_worker" },
        ],
        log_path: "data/integrations/developer_bridge/collaboration_runtime/logs/codex_operator.log",
        starts_arbitrary_commands: false,
      },
      {
      ...
      {
        name: "ollama_operator_participant",
        status: "running",
        running: true,
        pids: [231387, 231388],
        process_count: 2,
        process_model: "wrapper_child_pair",
        effective_worker_count: 1,
        effective_pids: [231388],
        wrapper_process_count: 1,
        wrapper_pids: [231387],
        processes: [
          { pid: 231387, parent_pid: 200004, role: "launcher_wrapper" },
          { pid: 231388, parent_pid: 231387, role: "effective_worker" },
        ],
        log_path: "data/integrations/developer_bridge/collaboration_runtime/logs/ollama_operator.log",
        starts_arbitrary_commands: false,
      },
    ],
    supervisor: {
    ...
    collaboration_loop: {
      ...
      live_health_evidence: {
        ...
        running_helper_count: 5,
        desired_helper_count: 5,
        effective_worker_count: 5,
